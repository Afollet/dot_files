...
#PS1='\[\e]0;\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}$(you_cool_bro)\e[0;34m$(fmt_time):\w\n$ \e[m'
#PS1="\[\u@\H:\W\] "
ulimit -S -n 2048
...
PATH=${PATH}":/home/alex/vcgs/sonar/sonar-scanner-4.8.0.2856-linux/bin"
nvm use 16.0.0
set -o vi
...
export PYTHONPATH=/home/alex/vcgs/giphub/gip/src/
